...
type File struct {
	...
	NumberOfPages null.Int  `boil:"number_of_pages" json:"number_of_pages,omitempty" toml:"number_of_pages" yaml:"number_of_pages,omitempty"`
...
var FileWhere = struct {
	...
	NumberOfPages whereHelpernull_Int
	StoreID       whereHelperstring
	CreatedAt     whereHelpernull_Time
	UpdatedAt     whereHelpernull_Time
	DeletedAt     whereHelpernull_Time
}{
	ID:            whereHelperstring{field: "\"upload_service\".\"file\".\"id\""},
	Title:         whereHelperstring{field: "\"upload_service\".\"file\".\"title\""},
	URL:           whereHelperstring{field: "\"upload_service\".\"file\".\"url\""},
	Type:          whereHelperstring{field: "\"upload_service\".\"file\".\"type\""},
	NumberOfPages: whereHelpernull_Int{field: "\"upload_service\".\"file\".\"number_of_pages\""},
	StoreID:       whereHelperstring{field: "\"upload_service\".\"file\".\"store_id\""},
	CreatedAt:     whereHelpernull_Time{field: "\"upload_service\".\"file\".\"created_at\""},
	UpdatedAt:     whereHelpernull_Time{field: "\"upload_service\".\"file\".\"updated_at\""},
	DeletedAt:     whereHelpernull_Time{field: "\"upload_service\".\"file\".\"deleted_at\""},
}
...
var (
	fileAllColumns            = []string{"id", "title", "url", "type", "number_of_pages", "store_id", "created_at", "updated_at", "deleted_at"}
	fileColumnsWithoutDefault = []string{"title", "url", "type", "store_id"}
	fileColumnsWithDefault    = []string{"id", "number_of_pages", "created_at", "updated_at", "deleted_at"}
...
func (o *File) Store(mods ...qm.QueryMod) storeQuery {
...
func (fileL) LoadStore(ctx context.Context, e boil.ContextExecutor, singular bool, maybeFile interface{}, mods queries.Applicator) error {
	var slice []*File
	var object *File
	...
	query := NewQuery(
		qm.From(`upload_service.store`),
		qm.WhereIn(`upload_service.store.id in ?`, args...),
		qmhelper.WhereIsNull(`upload_service.store.deleted_at`),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetStore of the file to the related item.
// Sets o.R.Store to related.
// Adds o to related.R.Files.
func (o *File) SetStore(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Store) error {
	var err error
	if insert {
...
func Files(mods ...qm.QueryMod) fileQuery {
	mods = append(mods, qm.From("\"upload_service\".\"file\""), qmhelper.WhereIsNull("\"upload_service\".\"file\".\"deleted_at\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"upload_service\".\"file\".*"})
	}
...
func FindFile(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*File, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"upload_service\".\"file\" where \"id\"=$1 and \"deleted_at\" is null", sel,
	)
...
func (o *File) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"upload_service\".\"file\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"upload_service\".\"file\" %sDEFAULT VALUES%s"
		}
...
func (o *File) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"upload_service\".\"file\" SET %s WHERE %s",
...
func (o FileSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"upload_service\".\"file\" SET %s WHERE %s",
...
func (o *File) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"upload_service\".\"file\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *File) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"upload_service\".\"file\" WHERE \"id\"=$1"
	} else {
		currTime := time.Now().In(boil.GetLocation())
		o.DeletedAt = null.TimeFrom(currTime)
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"upload_service\".\"file\" SET %s WHERE \"id\"=$2",
			strmangle.SetParamNames("\"", "\"", 1, wl),
		)
...
func (o FileSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	if hardDelete {
		...
		sql = "DELETE FROM \"upload_service\".\"file\" WHERE " +
		...
		wl := []string{"deleted_at"}
		sql = fmt.Sprintf("UPDATE \"upload_service\".\"file\" SET %s WHERE "+
...
func (o *FileSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"upload_service\".\"file\".* FROM \"upload_service\".\"file\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, filePrimaryKeyColumns, len(*o)) +
...
func FileExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"upload_service\".\"file\" where \"id\"=$1 and \"deleted_at\" is null limit 1)"
