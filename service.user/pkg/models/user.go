...
var UserWhere = struct {
	...
	ID:        whereHelperstring{field: "\"user_service\".\"user\".\"id\""},
	RoleID:    whereHelperstring{field: "\"user_service\".\"user\".\"role_id\""},
	CreatedAt: whereHelpernull_Time{field: "\"user_service\".\"user\".\"created_at\""},
}
...
var (
	userAllColumns            = []string{"id", "role_id", "created_at"}
	userColumnsWithoutDefault = []string{"id", "role_id"}
...
func Users(mods ...qm.QueryMod) userQuery {
	mods = append(mods, qm.From("\"user_service\".\"user\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"user_service\".\"user\".*"})
	}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"user_service\".\"user\" where \"id\"=$1", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"user_service\".\"user\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"user_service\".\"user\" %sDEFAULT VALUES%s"
		}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"user_service\".\"user\" SET %s WHERE %s",
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"user_service\".\"user\" SET %s WHERE %s",
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"user_service\".\"user\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"user_service\".\"user\" WHERE \"id\"=$1"
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"user_service\".\"user\" WHERE " +
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"user_service\".\"user\".* FROM \"user_service\".\"user\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, userPrimaryKeyColumns, len(*o))
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"user_service\".\"user\" where \"id\"=$1 limit 1)"
