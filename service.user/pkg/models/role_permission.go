...
var RolePermissionWhere = struct {
	...
	ID:           whereHelperstring{field: "\"user_service\".\"role_permission\".\"id\""},
	RoleID:       whereHelperstring{field: "\"user_service\".\"role_permission\".\"role_id\""},
	PermissionID: whereHelperstring{field: "\"user_service\".\"role_permission\".\"permission_id\""},
	CreatedAt:    whereHelpernull_Time{field: "\"user_service\".\"role_permission\".\"created_at\""},
}
...
var (
	rolePermissionAllColumns            = []string{"id", "role_id", "permission_id", "created_at"}
	rolePermissionColumnsWithoutDefault = []string{"id", "role_id", "permission_id"}
	rolePermissionColumnsWithDefault    = []string{"created_at"}
	rolePermissionPrimaryKeyColumns     = []string{"id", "role_id", "permission_id"}
...
func (rolePermissionL) LoadPermission(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRolePermission interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_service.permission`),
		qm.WhereIn(`user_service.permission.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (rolePermissionL) LoadRole(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRolePermission interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_service.role`),
		qm.WhereIn(`user_service.role.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *RolePermission) SetPermission(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Permission) error {
	...
	values := []interface{}{related.ID, o.ID, o.RoleID, o.PermissionID}
...
func RolePermissions(mods ...qm.QueryMod) rolePermissionQuery {
	mods = append(mods, qm.From("\"user_service\".\"role_permission\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"user_service\".\"role_permission\".*"})
	}
...
func FindRolePermission(ctx context.Context, exec boil.ContextExecutor, iD string, roleID string, permissionID string, selectCols ...string) (*RolePermission, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"user_service\".\"role_permission\" where \"id\"=$1 AND \"role_id\"=$2 AND \"permission_id\"=$3", sel,
	)

	q := queries.Raw(query, iD, roleID, permissionID)
...
func (o *RolePermission) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"user_service\".\"role_permission\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"user_service\".\"role_permission\" %sDEFAULT VALUES%s"
		}
...
func (o *RolePermission) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"user_service\".\"role_permission\" SET %s WHERE %s",
...
func (o RolePermissionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"user_service\".\"role_permission\" SET %s WHERE %s",
...
func (o *RolePermission) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"user_service\".\"role_permission\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *RolePermission) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"user_service\".\"role_permission\" WHERE \"id\"=$1 AND \"role_id\"=$2 AND \"permission_id\"=$3"
...
func (o RolePermissionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"user_service\".\"role_permission\" WHERE " +
...
func (o *RolePermission) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindRolePermission(ctx, exec, o.ID, o.RoleID, o.PermissionID)
	if err != nil {
		return err
	}
...
func (o *RolePermissionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"user_service\".\"role_permission\".* FROM \"user_service\".\"role_permission\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, rolePermissionPrimaryKeyColumns, len(*o))
...
func RolePermissionExists(ctx context.Context, exec boil.ContextExecutor, iD string, roleID string, permissionID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"user_service\".\"role_permission\" where \"id\"=$1 AND \"role_id\"=$2 AND \"permission_id\"=$3 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, iD, roleID, permissionID)
	}
	row := exec.QueryRowContext(ctx, sql, iD, roleID, permissionID)
